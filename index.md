...
- **[Brand]({{ '/brand' | relative_url }})** – the visual identity. Logo, colour, typography, imagery, templates.
- **[Style guide]({{ '/style-guide' | relative_url }})** – how we write. Voice, conventions, do-and-don't and the LLM system prompt that lets a language model draft on-brand copy on our behalf.
- **[Communications strategy]({{ '/communications-strategy' | relative_url }})** – who we're talking to, why, on what channels, and how we know it's working.
