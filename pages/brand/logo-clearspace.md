...
> _To author: minimum print size, minimum screen size in pixels._

## Don't

> _To author: list the violations to call out. Common ones: stretching, recolouring outside the palette, placing on busy backgrounds without a clearspace buffer, using the logomark alone where the wordmark is required._
