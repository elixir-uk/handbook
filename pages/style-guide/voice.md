...
This voice is constant. Webstory, social post, newsletter, email, grant copy – the voice doesn't shift. Tone does (see [Tone shifts by channel](#tone-shifts-by-channel) below).
...
{% include callout.html type="important" content="**We endorse our services; we don't own them.** Every ELIXIR-UK Service is built, run and funded by a UK research institution or team. ELIXIR-UK recognises, connects and amplifies them – but the work, the people and the credit belong to the host institution. Our copy should never imply ownership. Write *'FAIRsharing, an ELIXIR-UK service provided by the University of Oxford'* – not *'ELIXIR-UK's FAIRsharing'*." %}
