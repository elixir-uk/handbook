...
{% include callout.html type="note" content="**We're lax on social.** Any mention of ELIXIR-UK by members, partners or the community is a win. When in doubt, post. Don't over-think." %}
...
- **Job postings auto-post.** Zapier takes new UK vacancies from the [ELIXIR Hub vacancies page](https://elixir-europe.org/about-us/vacancies) and posts them to Slack and LinkedIn automatically. Don't manually re-share – let Zapier do its job.
