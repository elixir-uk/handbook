...
- Names and contact details listed on each working-group page.
...
Only the steepest paths exist. Great events for "Contributing" and "Co-creating" levels, but nothing for "Engaged". The pipeline dries up.

**Fix:** every level has a low-friction next action. The pathway is climbable, not a cliff.
