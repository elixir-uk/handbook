...
Annual All-Hands meeting, workshops, partner events, online community calls.
...
- **Async-first.** Not everyone can show up in real time.
- **Acknowledge work.** Contribution is named, not anonymised.
- **Hand off ownership where we can.** Working groups that depend on us forever are audiences, not communities.
